        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center mb-16">
                ...
                <div class="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-blue-200/50 via-purple-200/50 to-green-200/50 dark:from-red-600/20 dark:to-red-700/20 border border-blue-300/50 dark:border-red-500/30 text-blue-700 dark:text-red-300 text-sm font-medium mb-8 backdrop-blur-sm animate-fade-in-up">
                 ...
                 <div class="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-green-200/50 via-purple-200/50 to-blue-200/50 dark:from-red-600/20 dark:to-red-700/20 border border-blue-300/50 dark:border-red-500/30 text-blue-700 dark:text-red-300 text-sm font-medium mb-8 backdrop-blur-sm animate-fade-in-up">
                    <svg class="w-5 h-5 mr-3 animate-bounce" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M4 2a1 1 0 00-1 1v14h2v-2h10v2h2V3a1 1 0 00-1-1H4zm3 4a1 1 0 012 0v1a1 1 0 01-2 0V6zm0 3a1 1 0 012 0v1a1 1 0 01-2 0V9zm4-3a1 1 0 012 0v1a1 1 0 01-2 0V6zm0 3a1 1 0 012 0v1a1 1 0 01-2 0V9z" clip-rule="evenodd" />
                    </svg>
                   Department of {{ $staffMember->department ?? 'Note your concerns here' }}
                </div>
                </div>
