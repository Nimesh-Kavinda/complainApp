...
<section class="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-black dark:via-gray-900 dark:to-red-950 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center mb-16">
                <div class="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 dark:from-red-600/20 dark:to-red-700/20 border border-blue-400/30 dark:border-red-500/30 text-blue-700 dark:text-red-300 text-sm font-medium mb-8 backdrop-blur-sm animate-fade-in-up">
                    <svg class="w-5 h-5 mr-3 animate-bounce" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                    </svg>
                    VAMPIOR DESIGNS - External Complaint Portal
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up delay-700">
                   <a href="{{ route('client.complain') }}">
                    ...
                    <a href="{{ route('client.past-complaints') }}">
                        <button class="group w-full sm:w-auto px-10 py-5 bg-white/90 dark:bg-black/80 backdrop-blur-sm text-gray-700 dark:text-gray-100 font-bold rounded-2xl border-2 border-green-500/30 dark:border-red-500/30 hover:border-green-400 dark:hover:border-red-400 hover:bg-white dark:hover:bg-black hover:shadow-xl hover:shadow-green-500/20 dark:hover:shadow-red-500/20 hover:-translate-y-3 hover:scale-105 transition-all duration-500 relative overflow-hidden">
                            <div class="absolute inset-0 bg-gradient-to-r from-green-500/0 via-green-500/10 to-green-500/0 dark:from-red-500/0 dark:via-red-500/10 dark:to-red-500/0 -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                            <span class="flex items-center justify-center relative z-10">
