...
.file-upload-area:hover {
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.08), rgba(147, 51, 234, 0.05), rgba(34, 197, 94, 0.03));
...
.bg-floating:nth-child(2) {
    ...
    animation-delay: 2s; background: linear-gradient(135deg, #8b5cf6, #22c55e);
}
.bg-floating:nth-child(3) {
    bottom: 30%; left: 20%; width: 40px; height: 40px;
    animation-delay: 4s; background: linear-gradient(135deg, #22c55e, #3b82f6);
}
...
.dark .bg-floating:nth-child(3) {
    ...
    <section id="complaint-form" class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-100 via-blue-100 to-purple-100 dark:from-black dark:via-gray-900 dark:to-red-950 transition-all duration-500 relative overflow-hidden min-h-screen">
        <!-- Floating Background Elements -->
    ...
    <div class="max-w-3xl mx-auto bg-white/90 dark:bg-black/90 backdrop-blur-lg shadow-2xl rounded-3xl p-8 space-y-8 border border-blue-200/30 dark:border-red-800/30 relative z-10 hover:shadow-blue-500/10 dark:hover:shadow-red-500/10 transition-all duration-500">
        ...
        @if ($errors->any())
            <div class="bg-blue-100 dark:bg-red-900/30 border-l-4 border-blue-500 dark:border-red-500 text-blue-700 dark:text-red-300 px-6 py-4 rounded-r-lg animate-slide-in-left shadow-lg">
        ...
        <form action="{{ route('client.complaint.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="form-field group">
                ...
                <input type="text" id="name" name="name" required
                       class="mt-1 w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-green-500/20 dark:focus:ring-red-500/20 dark:focus:border-red-500 input-focus transition-all duration-300 hover:border-purple-300 dark:hover:border"
            ...
            <div class="form-field group">
                ...
                <select id="category" name="category" required class="mt-1 w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-green-500/20 dark:focus:ring-red-500/20 dark:focus:border-red-500 input-focus transition-all duration-300 hover:border-purple-300 dark:hover:border cursor-pointer">
            ...
            <div class="form-field group">
                ...
                <select id="priority" name="priority" class="mt-1 w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-green-500/20 dark:focus:ring-red-500/20 dark:focus:border-red-500 input-focus transition-all duration-300 hover:border-purple-300 dark:hover:border cursor-pointer">
            ...
            <div class="form-field group">
                ...
                <textarea id="details" name="details" rows="6" required class="mt-1 w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-green-500/20 dark:focus:ring-red-500/20 dark:focus:border-red-500 input-focus transition-all duration-300 hover:border-purple-300 dark:hover:border resize-none" placeholder="Please provide detailed information about your complaint including:
• What happened?
• When did it occur?
• Who was involved?
