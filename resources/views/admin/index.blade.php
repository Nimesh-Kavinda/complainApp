  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-x-auto">
    ...
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
      <thead class="bg-gray-50 dark:bg-gray-700">
        <tr>
          <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 dark:text-red-300 uppercase">Name</th>
          <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 dark:text-red-300 uppercase">Email</th>
          <th class="px-6 py-3 text-left text-xs font-medium text-blue-500 dark:text-red-300 uppercase">Role</th>
        </tr>
      </thead>
